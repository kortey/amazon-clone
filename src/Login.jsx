  ...
  return (
    <div className="login__container">
        ...
        <form action="">
            ...
            <input type="password" name='pasword' value={password} onChange={ changePassword}/>
            <button className='signin__btn' type="submit" onClick={signin}> Sign in</button>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Eius saepe adipisci hic ex maxime tempora i
            </p>
            <button type="submit" className='create__btn' onClick={register}>create your amazon account</button>
        </form>
